...
import { CartEmptyIcon, CloseIcon, DeleteIcon } from "../../assets/icons"
      ...
      <div className={`modal-content ${modalOpen && 'active'}`}>
...

        {
          items.length === 0 ? <>
            ...
            <CartEmptyIcon/>
            <p className="modal-body_text">В вашей корзине ничего нет</p>
            <button className="modal-body_btn">Перейти в каталог</button>
            </div>
          </> :
